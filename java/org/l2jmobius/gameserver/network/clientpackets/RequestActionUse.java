...
import org.l2jmobius.gameserver.events.instanced.types.SimonSays;
...
public class RequestActionUse implements IClientIncomingPacket
{
	...
	public void run(GameClient client)
	{
		...
		if (actionHolder != null)
		{
			...
			{
				if (player.isPlayingEvent() && player.getEvent() instanceof SimonSays) {
					((SimonSays) player.getEvent()).onSocialAction(player, actionHolder.getOptionId());
				}
