...
import org.l2jmobius.gameserver.model.zone.*;
import org.l2jmobius.gameserver.model.zone.type.*;
...
public class ZoneManager implements IXmlReader
{
	...
	public void load()
	{
		...
		_classZones.put(FarmZone.class, new ConcurrentHashMap<>());
		_classZones.put(MainTown.class, new ConcurrentHashMap<>());
		...
		parseDatapackDirectory("data/zones/farmzone", false);
