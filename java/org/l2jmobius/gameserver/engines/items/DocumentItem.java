			...
			else if ("skills".equalsIgnoreCase(n.getNodeName()))
			{
				...
				for (Node b = n.getFirstChild(); b != null; b = b.getNextSibling())
				{
					if ("skill".equalsIgnoreCase(b.getNodeName()))
					{
						...
						final ItemSkillAgathion agath = parseEnum(b.getAttributes(), ItemSkillAgathion.class, "slot", ItemSkillAgathion.NORMAL);
						_currentItem.item.addSkill(new ItemSkillHolder(id, level, type, chance, value, agath));
					}
				}
			}
