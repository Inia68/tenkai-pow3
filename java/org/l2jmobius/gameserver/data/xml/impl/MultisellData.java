...
public class MultisellData implements IXmlReader
{
	...
	public void parseDocument(Document doc, File f)
	{
		...
		final EnchantItemGroup broochGroup = EnchantItemGroupsData.getInstance().getItemGroup("BROOCH_GROUP");
		final int broochGroupMax = broochGroup != null ? broochGroup.getMaximumEnchant() : 0;
