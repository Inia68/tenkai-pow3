...
public abstract class Creature extends WorldObject implements ISkillsHolder, IDeletable
{
	...
	public boolean isInsideZone(ZoneId zone)
	{
		...
		switch (zone)
		{
			case PVP:
			{
				if ((instance != null) && instance.isPvP() || (instance!= null && isPlayer() && (((PlayerInstance)this).isPlayingEvent())))
				{
					return true;
				}
	...
	public Skill addSkill(Skill newSkill)
	{
		...
		if (newSkill != null)
		{
			if (newSkill.isPassive() && newSkill.checkConditions(SkillConditionScope.PASSIVE, this, this) == false) {
				return null;
			}
	...
	public Skill addSkill(Skill newSkill, boolean force)
	{
		Skill oldSkill = null;
		if (newSkill != null)
		{
			if (force == false && newSkill.isPassive() && newSkill.checkConditions(SkillConditionScope.PASSIVE, this, this) == false) {
				return null;
			}
