				...
				for (DamageDoneInfo reward : rewards.values())
				{
					...
					if (attackerParty == null)
					{
						...
						if (isInSurroundingRegion(attacker))
						{
							...
							if (Config.RATE_XP_100_110 > 0 && attacker.getLevel() >= 100 && attacker.getLevel() < 110) {
								exp *= Config.RATE_XP_100_110;
							} else if (Config.RATE_XP_110_120 > 0 && attacker.getLevel() >= 110 && attacker.getLevel() < 120) {
					...
					else
					{
						...
						if (Config.RATE_XP_100_110 > 0 && partyLvl >= 100 && partyLvl < 110) {
							exp *= Config.RATE_XP_100_110;
						} else if (Config.RATE_XP_110_120 > 0 && partyLvl >= 110 && partyLvl < 120) {
							exp *= Config.RATE_XP_110_120;
						}
