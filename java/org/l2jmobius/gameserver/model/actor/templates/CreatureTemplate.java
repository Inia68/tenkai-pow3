...
public class CreatureTemplate extends ListenersContainer
{
	...
	public void setBaseHpMax(double value) {
		_baseValues.replace(Stat.MAX_HP, value);
	}

	public void setBaseMDef(double value) {
		_baseValues.replace(Stat.MAGICAL_DEFENCE, value);
	}

	public void setBasePDef(double value) {
		_baseValues.replace(Stat.PHYSICAL_DEFENCE, value);
	}

	public void setBasePAtk(double value) {
		_baseValues.replace(Stat.PHYSICAL_ATTACK, value);
		_baseValues.replace(Stat.MAGIC_ATTACK, value);
	}
