...
public abstract class AbstractEnchantItem
{
	...
	public boolean isValid(ItemInstance itemToEnchant, EnchantSupportItem supportItem)
	{
		...
		else if ((itemToEnchant.getId() == 80835 || itemToEnchant.getId() == 80836) && itemToEnchant.getEnchantLevel() >= 5) {
			return false;
		}
		else if ((itemToEnchant.getId() == 48202 || itemToEnchant.getId() == 48205 || itemToEnchant.getId() == 48208
				|| itemToEnchant.getId() == 48203 || itemToEnchant.getId() == 48206 || itemToEnchant.getId() == 48209
				|| itemToEnchant.getId() == 48491 || itemToEnchant.getId() == 48492 || itemToEnchant.getId() == 81359 ) && itemToEnchant.getEnchantLevel() >= 5) {
			return false;
		}
