...
public class ClassInfo
{
	...
	{
		if (_parentClassId == null)
		{
			return 0;
		}

		if (_classId == ClassId.MARAUDER || _classId == ClassId.CLOUD_BREAKER)
		{
			return 2;
		}

		return 1 + _parentClassId.level();
	}
	...
	public final boolean childOf(ClassId cl)
	{
		if (_parentClassId == null)
		{
			return false;
		...
		if (_parentClassId == cl)
		{
			return true;
		}

		return _parentClassId.childOf(cl);
	}
}
